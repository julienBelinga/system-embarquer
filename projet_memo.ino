...
void put_on_led(int x,int y, int hexaColor){
  trellis.setPixelColor(x, y, hexaColor); //addressed with x,y
  trellis.show(); //show all LEDs
}
int get_random_number(){
  aleatoire = random(1,9);
  return aleatoire;
}
void cursus_led(){
  put_on_led(get_random_number(),get_random_number(), (int)0x40cf40);
}
